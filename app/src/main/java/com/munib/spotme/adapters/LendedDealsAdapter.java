...
public class LendedDealsAdapter extends RecyclerView.Adapter<LendedDealsAdapter.RestaurantViewHolder>{
    private ArrayList<DataModel> dataModels;
    SharedPreferences pref;
    SharedPreferences.Editor editor;
    private Context mContext;

    public LendedDealsAdapter(Context context, ArrayList<DataModel> dataModels) {
        mContext = context;
    ...
    @Override
    public LendedDealsAdapter.RestaurantViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(LendedDealsAdapter.RestaurantViewHolder holder, int position) {
