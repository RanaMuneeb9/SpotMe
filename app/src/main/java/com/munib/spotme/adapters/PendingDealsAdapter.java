...
public class PendingDealsAdapter extends RecyclerView.Adapter<PendingDealsAdapter.RestaurantViewHolder>{
    private ArrayList<DataModel> dataModels;
    SharedPreferences pref;
    SharedPreferences.Editor editor;
    private Context mContext;

    public PendingDealsAdapter(Context context, ArrayList<DataModel> dataModels) {
        mContext = context;
    ...
    @Override
    public PendingDealsAdapter.RestaurantViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_item_pending, parent, false);
        RestaurantViewHolder viewHolder = new RestaurantViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(PendingDealsAdapter.RestaurantViewHolder holder, int position) {
